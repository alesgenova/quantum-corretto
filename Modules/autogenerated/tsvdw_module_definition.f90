alloc_args = {}
init_args = {"vdw_isolated": {"type": "logical", "dimension": null}, "vdw_econv_thr": {"type": "real(dp)", "dimension": null}, "vdw_lscreen": {"type": "logical", "dimension": null}, "vdw_lstep0": {"type": "logical", "dimension": null}, "vdw_small_box": {"type": "logical", "dimension": null}, "EtsvdW": {"type": "real(dp)", "dimension": null}, "UtsvdW": {"type": "real(dp)", "dimension": ":"}, "FtsvdW": {"type": "real(dp)", "dimension": ":,:"}, "HtsvdW": {"type": "real(dp)", "dimension": ":,:"}, "VefftsvdW": {"type": "real(dp)", "dimension": ":"}, "NgpA": {"type": "integer", "dimension": null}, "bsint": {"type": "integer", "dimension": null}, "me": {"type": "integer", "dimension": null}, "iproc": {"type": "integer", "dimension": null}, "nr1": {"type": "integer", "dimension": null}, "nr2": {"type": "integer", "dimension": null}, "nr3": {"type": "integer", "dimension": null}, "nr1r": {"type": "integer", "dimension": null}, "nr2r": {"type": "integer", "dimension": null}, "nr3r": {"type": "integer", "dimension": null}, "n_PBC_img_grid_atom": {"type": "integer", "dimension": null}, "n_PBC_img_atom_atom": {"type": "integer", "dimension": null}, "ddamp": {"type": "real(dp)", "dimension": null}, "sR": {"type": "real(dp)", "dimension": null}, "spcutAmax": {"type": "real(dp)", "dimension": null}, "nstates": {"type": "integer", "dimension": ":"}, "sdispls": {"type": "integer", "dimension": ":"}, "rdispls": {"type": "integer", "dimension": ":"}, "sendcount": {"type": "integer", "dimension": ":"}, "recvcount": {"type": "integer", "dimension": ":"}, "istatus": {"type": "integer", "dimension": ":"}, "NsomegaA": {"type": "integer", "dimension": ":"}, "NsomegaAr": {"type": "integer", "dimension": ":"}, "npair": {"type": "integer", "dimension": ":"}, "pair": {"type": "integer", "dimension": ":,:"}, "gomegar": {"type": "integer", "dimension": ":,:"}, "wrp_img_grid_atom": {"type": "integer", "dimension": ":,:"}, "wrp_img_atom_atom": {"type": "integer", "dimension": ":,:"}, "BsomegaAr": {"type": "integer", "dimension": ":,:"}, "somegaA": {"type": "integer", "dimension": ":,:,:"}, "somegaAr": {"type": "integer", "dimension": ":,:,:"}, "gomegaAr": {"type": "integer", "dimension": ":,:,:"}, "predveffAdn": {"type": "real(dp)", "dimension": ":"}, "vfree": {"type": "real(dp)", "dimension": ":"}, "dpfree": {"type": "real(dp)", "dimension": ":"}, "R0free": {"type": "real(dp)", "dimension": ":"}, "C6AAfree": {"type": "real(dp)", "dimension": ":"}, "veff": {"type": "real(dp)", "dimension": ":"}, "dpeff": {"type": "real(dp)", "dimension": ":"}, "R0eff": {"type": "real(dp)", "dimension": ":"}, "C6AAeff": {"type": "real(dp)", "dimension": ":"}, "rhosad": {"type": "real(dp)", "dimension": ":"}, "rhotot": {"type": "real(dp)", "dimension": ":"}, "dveffAdn": {"type": "real(dp)", "dimension": ":,:"}, "spgrd": {"type": "real(dp)", "dimension": ":,:"}, "sprho": {"type": "real(dp)", "dimension": ":,:"}, "spdrho": {"type": "real(dp)", "dimension": ":,:"}, "spdata": {"type": "real(dp)", "dimension": ":,:"}, "LIA": {"type": "real(dp)", "dimension": ":,:"}, "LIB": {"type": "real(dp)", "dimension": ":,:"}, "dLIA": {"type": "real(dp)", "dimension": ":,:"}, "dLIB": {"type": "real(dp)", "dimension": ":,:"}, "atxyz": {"type": "real(dp)", "dimension": ":,:"}, "C6ABfree": {"type": "real(dp)", "dimension": ":,:"}, "C6ABeff": {"type": "real(dp)", "dimension": ":,:"}, "dveffdR": {"type": "real(dp)", "dimension": ":,:,:"}, "dveffdh": {"type": "real(dp)", "dimension": ":,:,:"}}
type :: tsvdw_module_type
  logical :: is_alloc = .false.
  logical :: is_init = .false.
  logical :: vdw_isolated
  real(dp) :: vdw_econv_thr
  logical :: vdw_lscreen = .true.
  logical :: vdw_lstep0 = .true.
  ...
  integer :: nr2r
  integer :: nr3r
  integer :: n_PBC_img_grid_atom
  integer :: n_PBC_img_atom_atom
  real(dp) :: ddamp
  real(dp) :: sR
  real(dp) :: spcutAmax
  ...
  integer, allocatable, dimension(:,:) :: wrp_img_grid_atom ! dimensions = [":", ":"]
  integer, allocatable, dimension(:,:) :: wrp_img_atom_atom ! dimensions = [":", ":"]
  integer, allocatable, dimension(:,:) :: BsomegaAr ! dimensions = [":", ":"]
