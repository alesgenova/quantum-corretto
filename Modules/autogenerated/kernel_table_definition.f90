alloc_args = {}
init_args = {"Nqs": {"type": "integer", "dimension": null}, "Nr_points": {"type": "integer", "dimension": null}, "r_max": {"type": "real(dp)", "dimension": null}, "q_cut": {"type": "real(dp)", "dimension": null}, "q_min": {"type": "real(dp)", "dimension": null}, "dk": {"type": "real(dp)", "dimension": null}, "q_mesh": {"type": "real(dp)", "dimension": ":"}, "kernel": {"type": "real(dp)", "dimension": ":,:,:"}, "d2phi_dk2": {"type": "real(dp)", "dimension": ":,:,:"}, "vdw_table_name": {"type": "character(len=256)", "dimension": null}, "double_format": {"type": "character(len=30)", "dimension": null}, "vdw_kernel_md5_cksum": {"type": "character(len=32)", "dimension": null}, "find_free_unit": {"type": "integer", "dimension": null}}
