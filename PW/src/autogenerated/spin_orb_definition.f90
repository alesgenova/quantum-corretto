alloc_args = {}
init_args = {"lspinorb": {"type": "logical", "dimension": null}, "starting_spin_angle": {"type": "logical", "dimension": null}, "domag": {"type": "logical", "dimension": null}, "rot_ylm": {"type": "complex(dp)", "dimension": ":,:,:,:"}, "fcoef": {"type": "complex(dp)", "dimension": ":,:,:,:,:"}}
type :: spin_orb_type
